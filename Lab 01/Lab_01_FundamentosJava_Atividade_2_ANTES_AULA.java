...
public class Lab_01_FundamentosJava_Atividade_2_ANTES_AULA  {

	// CASE 1: EXIBI NUMEROS PARES DE UM INTERVALO
	public void exibiPares(Scanner teclado) {
	...
	public void alfabeto(Scanner teclado) {
	...
	public void multiplosDe3(Scanner teclado) {
	...
	public void horasMinutosSegundosParaSegundos(Scanner teclado) {
		// declaração de variáveis para esta Ação
	...
	public void minutosParaHorasEMinutos(Scanner teclado) {
		// declaração de variável para esta Ação
		int qtdMinutos;
		int qtdHoras;
	...
	public static void main(String[] args) throws Exception {
		...
		// INSTANCIAÇÃO DO 'RESTANTE' DO CODIGO (PARTE NÃO ESTÁTICA)
		Lab_01_FundamentosJava_Atividade_2_ANTES_AULA acoes = new Lab_01_FundamentosJava_Atividade_2_ANTES_AULA();
